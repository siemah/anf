    ...
    <div className={`hero hero-block`}>
	    ...
	    <section className="content-block">
	    	<Container>
	    		<Row>
	    			<Col s='12'>
	    				<article className="content-block__description opacity-0 js-slide-from-down" data-delay={.2}>
	    					<p className='left'>
    						...
    						<p>
	    						Pour atteindre les objectifs escomptés par l’association, tous les efforts qui
									...
									l’amélioration, à l’évolution et au développement. 
								</p>
								<p>
	    				...
	    				<aside className='right opacity-0 js-slide-from-down' data-delay={.5}>
								<h2>HADJAMMAR Ferhat </h2>
								<h3>Président de l'ANF</h3>
							</aside>
	    			</Col>
	    		</Row>
	    	</Container>
